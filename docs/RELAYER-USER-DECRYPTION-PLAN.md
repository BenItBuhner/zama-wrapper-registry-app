...
- tests cover missing handles, malformed addresses, the documented 2048-bit batch limit, missing wallet connection, missing signing capability, address mismatch, absent providers, malformed provider accounts, UI signing-session summaries, fake-provider typed-data calls, and guarded Sepolia transaction submission
